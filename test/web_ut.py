...
class ISelenium(unittest.TestCase):
    ...
    def get_config(self):
        ...
        config.read(os.path.join(r'C:\Users\Asus\Desktop\iSelenium_Python', 'iselenium.ini'))
        return config
    ...
    def setUp(self):
        ...
        # exc = config.get('driver','chrome_driver')
        # print(exc)
        self.driver = webdriver.Chrome(executable_path=r'C:\Users\Asus\AppData\Local\Programs\Python\Python38\chromedriver.exe',options=chrome_options)
        # self.driver = webdriver.Chrome(executable_path=exc,options=chrome_options)
